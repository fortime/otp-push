...
@Composable
fun BluetoothServerDevicesScreen(
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        PullToRefreshBox(
            ...
            LazyColumn(
                ...
                if (appContext.bleScanning && !isRefreshing) {
                    item {
                        Box(
                            modifier = Modifier.fillMaxWidth(),
        ...
        if (!appContext.bleScanning) {
            FloatingActionButton(
                onClick = {
                    context.sendBroadcast(intentManager.genBleScanningToggleBroadcastIntent(true))
                },
                modifier = Modifier
                ...
                Icon(
                    ...
                    contentDescription = "Scan clients"
                )
            }
        }
    }
